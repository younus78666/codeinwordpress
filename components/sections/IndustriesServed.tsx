...
const industries = [
  {
    ...
    description: 'HIPAA-aware sites for clinics, dentists, and specialists.',
    icon: (
  ...
  },
  {
    ...
    description: 'Professional sites that build trust and drive intake forms.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Menu-driven sites with online ordering and reservations.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Lead-generating sites with project portfolios and quotes.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.1-5.1a2.1 2.1 0 112.97-2.97l5.1 5.1m-7.07 7.07l-2.83 2.83a1.5 1.5 0 01-2.12-2.12l2.83-2.83m7.07-7.07l2.83-2.83a1.5 1.5 0 012.12 2.12l-2.83 2.83M15.17 11.42l5.1 5.1a2.1 2.1 0 11-2.97 2.97l-5.1-5.1" />
      </svg>
    ),
  },
  {
    name: 'Real Estate',
    description: 'Listing-ready sites with IDX integration and lead capture.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'WooCommerce stores built to convert and scale.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Immersive sites with booking systems and trail guides.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Mission-focused sites with donation and enrollment tools.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IndustriesServed() {
  return (
    <SectionWrapper
      id="industries"
      heading="Built for Every Industry in New Mexico"
      subheading="From healthcare to hospitality, we understand the unique needs of local businesses and build WordPress sites that work for your specific industry."
      background="alt"
    >
