...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'Most projects take 2 to 4 weeks from kickoff to launch. A simple starter site can be ready in under two weeks, while complex builds with WooCommerce, custom features, or multilingual support may take 4 to 6 weeks. We provide a clear timeline during our initial consultation.',
    category: 'general',
  },
  {
    question: 'Do you work with businesses outside New Mexico?',
    answer: 'Absolutely. While we specialize in serving New Mexico businesses in Albuquerque, Santa Fe, Las Cruces, and beyond, we work with clients across the United States, Canada, UK, and Australia. All communication happens remotely via video calls, email, and project management tools.',
    category: 'general',
  },
  {
    question: 'What makes you different from other WordPress agencies?',
    answer: 'We combine deep technical WordPress expertise with advanced SEO knowledge. Every site we build is optimized for speed, security, and search engine visibility from day one. With 400+ completed projects and a 99% client satisfaction rate, we focus on measurable results, not just aesthetics.',
    category: 'general',
  },
  {
  ...
  },
  {
    ...
    answer: 'That is one of our core specialties. We audit your site for bottlenecks including unoptimized images, render-blocking scripts, bloated plugins, and poor hosting configurations. Our speed optimization service typically improves Lighthouse scores by 40 to 60 points with measurable before-and-after results.',
    category: 'services',
  },
  {
    question: 'Do you provide SEO services alongside web development?',
    answer: 'Yes. Every website we build includes foundational SEO with proper meta tags, schema markup, XML sitemaps, and clean URL structures. For businesses that need ongoing SEO, we offer comprehensive plans including keyword research, content strategy, technical audits, and monthly ranking reports.',
    category: 'services',
  },
  {
    question: 'How much does a WordPress website cost?',
    answer: 'Our WordPress websites start at $500 for a starter site with up to 10 pages. Professional sites with up to 20 pages and additional features are $900. Complex builds including WooCommerce stores and enterprise sites start at $1,500. Every project includes a 14-day money-back guarantee and 6 months of free post-launch support.',
    category: 'pricing',
  },
  {
