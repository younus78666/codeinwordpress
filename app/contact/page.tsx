...
export default function ContactPage() {
  return (
    <>
      ...
      <SectionWrapper heading="What to Expect When You Reach Out" subheading="Our process is designed to respect your time and give you clarity from the very first conversation.">
      ...
      <SectionWrapper heading="Working with Code In WordPress" subheading="What makes our client relationships different from the typical agency experience.">
        <div className="max-w-4xl mx-auto">
          <AnimateOnScroll>
            <div className="prose prose-lg max-w-none prose-headings:font-heading prose-p:text-secondary-600 prose-p:leading-relaxed">
