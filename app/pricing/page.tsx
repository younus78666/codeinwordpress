...
export default function PricingPage() {
  ...
  return (
    <>
      ...
      <SectionWrapper heading="Understanding WordPress Website Costs" subheading="A transparent, experience-driven breakdown of what you are paying for and why it matters.">
